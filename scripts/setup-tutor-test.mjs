// Script de setup para Tutor test — ES module
  ...
  try {
    ...
    try {
      ...
      if (e.code === 'auth/email-already-in-use') {
        ...
        tutorUser = await signInWithEmailAndPassword(auth, tutorEmail, tutorPassword);
      } else throw e;
    }
    ...
    try {
      ...
      if (e.code === 'auth/email-already-in-use') {
        ...
        estudianteUser = await signInWithEmailAndPassword(auth, estudianteEmail, estudiantePassword);
      } else throw e;
    }
