...
export default defineConfig(({ mode }) => {
  ...
  return {
    define: {
      ...
      'process.env.VITE_FUNCTIONS_EMULATOR_HOST': JSON.stringify(getEnv('VITE_FUNCTIONS_EMULATOR_HOST')),
      'process.env.VITE_FUNCTIONS_EMULATOR_PORT': JSON.stringify(getEnv('VITE_FUNCTIONS_EMULATOR_PORT')),
      'process.env.VITE_ASSISTANT_LOCAL_URL': JSON.stringify(getEnv('VITE_ASSISTANT_LOCAL_URL')),
