...
// Logo Oficial - TuDoJang (Usando archivo SVG para 100% fidelidad de gradientes)
export const IconoLogoOficial: React.FC<IconoProps> = ({ className = "w-12 h-12" }) => (
  <img
...
export const IconoLogoOficialConTexto: React.FC<IconoProps> = ({ className = "w-48 h-16" }) => (
  <img
    src="/Logo_TuDojang.svg"
    alt="TuDoJang"
    className={className as string}
