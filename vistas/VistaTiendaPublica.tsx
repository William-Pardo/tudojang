...
const VistaTiendaPublica: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    if (!implementos || implementos.length === 0) {
      return <EmptyState Icono={LogoDinamico} titulo="Tienda No Disponible" mensaje="Actualmente no hay implementos para mostrar. Por favor, intente más tarde." />;
    }
    return (
    ...
    <div className="min-h-screen bg-tkd-gray dark:bg-tkd-dark p-4 sm:p-8">
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-8">
          <LogoDinamico aria-label="Logo Academia" className="w-24 h-24 mx-auto mb-4" />
