            ...
            <>
                ...
                <div className="space-y-4">
                    <div className="flex justify-between px-1">
                        <span className="text-[9px] font-black uppercase text-gray-400">Firma Manual Requerida</span>
                        <button onClick={limpiarFirma} className="text-[9px] font-black text-tkd-blue uppercase hover:underline">Borrar</button>
                    </div>
                    <canvas
                        ref={canvasRef}
                        width="500"
