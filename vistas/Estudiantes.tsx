...
// Componentes
import { IconoAgregar, IconoEstudiantes, IconoExportar, IconoCertificado, IconoInformacion, IconoCampana, IconoCarnets, IconoControlAsistencia } from '../components/Iconos';
...
export const VistaEstudiantes: React.FC = () => {
    ...
    const tabs = [
        ...
        { id: 'asistencia', label: 'Control de Asistencia', icono: IconoControlAsistencia, visible: true },
        { id: 'certificados', label: 'Certificaciones', icono: IconoCertificado, visible: !esTutor },
        { id: 'carnets', label: 'Carnetización', icono: IconoCarnets, visible: !esTutor && usuario?.rol !== RolUsuario.Asistente },
    ].filter(t => t.visible);
