...
- [x] `components/FilaEstudiante.tsx`
- [x] `components/FiltrosEstudiantes.tsx`
- [x] `components/TablaEstudiantes.tsx`

### Fase 3: Formulario Estudiante (Core del Flujo)
- [x] Refactor y reactividad en `components/FormularioEstudiante.tsx`
- [x] Cobertura 100% en `components/FormularioEstudiante.test.tsx` (Triangulación de edades, validaciones de campos y manejo de errores de envío).

### Fase 4: Vista de Integración Principal
- [x] Cobertura 100% en `vistas/Estudiantes.tsx` (Flujos completos, carga, búsqueda, eliminación y modales).
